...
class CreateCaterShopTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cater_shop', function (Blueprint $table) {
            ...
            $table->integer('province_id')->default('0')->comment("关联provinces表,省份provinceid");
            $table->integer('city_id')->default('0')->comment("关联cities表,城市cityid");
            $table->integer('area_id')->default('0')->comment("关联areas表,区域areaid");
