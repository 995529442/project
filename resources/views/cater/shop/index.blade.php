...
@section('content')
    ...
    <form class="layui-form" action="{{ route('cater.shop.saveShop') }}" method="post" enctype="multipart/form-data"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" autocomplete="off" class="layui-input"
                       value="{{$shops_info['name']}}" style="width:40%;">
            </div>
        </div>
        ...
        <div class="layui-form-item" id="take_out"
             @if($shops_info == "" || $shops_info['is_take_out'] == 1)style="display:none;" @endif>
            ...
            <div class="layui-input-inline">
                <input type="text" name="delivery_fee" id="delivery_fee" autocomplete="off" class="layui-input"
                       ...
                       style="width:80%;display:inline-block;margin-right:5px;">元
            </div>
        ...
        <div class="layui-form-item" id="take_out_delivery"
             @if($shops_info == "" || $shops_info['is_take_out'] == 1)style="display:none;" @endif>
            ...
            <div class="layui-input-inline">
                ...
                style="width:80%;display:inline-block;margin-right:5px;">公里
            </div>
        </div>
        <div class="layui-form-item">
