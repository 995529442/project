        ...
        <form method="get" action="{{ route('cater.category.index') }}">
            ...
            <div class="demoTable formn">
                ...
                <div class="layui-inline">
                    <input type="text" name="cate_name" id="cate_name" autocomplete="off" class="layui-input"
                           value="{{$cate_name}}">
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="layui-btn layui-btn-normal layui-btn-sm"
                                    onclick="category_operate({{$v->id}},'edit')">编辑
                            </button>
                            <button class="layui-btn layui-btn-danger layui-btn-sm"
                                    onclick="category_operate({{$v->id}},'del')">删除
                            </button>
                        </td>
                    </tr>
                @endforeach
