...
<form class="layui-form" action="{{ route('saveSmsTemplate') }}" method="post" onsubmit="return check_submit();">
    ...
    <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="template_id" id="template_id" autocomplete="off" class="layui-input" value="@if($temp_info){{$temp_info->template_id}}@endif" style="width:30%;">
	    </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="checkbox" name="is_on_box" @if($temp_info && $temp_info->is_on == 1) checked @endif id="is_on_box" lay-skin="switch" lay-text="ON|OFF" lay-filter="is_on_box">
